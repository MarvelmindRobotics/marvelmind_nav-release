## marvelmind_nav (noetic) - 1.0.13-1

The packages in the `marvelmind_nav` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release marvelmind_nav --rosdistro noetic` on `Sun, 20 Nov 2022 19:43:30 -0000`
...
## marvelmind_nav (noetic) - 1.0.12-5
